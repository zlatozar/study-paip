...
;; just element (number in our case). Think of the output of the `successors-fn' not
;; as a starting state but as a list of possible states from which the goal may be reached.
;; This data represents the fringe of the tree that has been explored so far. That's why
;; for the begging we pass the whole tree.
;;
